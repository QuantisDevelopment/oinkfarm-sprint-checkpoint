...
**Started:** 23:27 CEST on 18 Apr 2026  
**Finished:** 00:07 CEST on 20 Apr 2026  
**Elapsed:** 24.7 h wall-clock  
...
|---|---|---|---|---|
| [Wave 1](../waves/wave-1.md) | Core schema & formula primitives | [A1](../tasks/A1-signal-events-schema.md) · [A2](../tasks/A2-remaining-pct-model.md) · [A3](../tasks/A3-auto-filled-at.md) | 24.7 h | 3/3 shipped |
| [Wave 2](../waves/wave-2.md) | Lifecycle accuracy & phantom-trade prevention | [A4](../tasks/A4-partially-closed-status.md) · [A7](../tasks/A7-update-new-detection.md) · [A5](../tasks/A5-confidence-scoring.md) | 19.9 h | 3/3 shipped |
| [Wave 3](../waves/wave-3.md) | Metadata enrichment & ghost closure | [A6](../tasks/A6-ghost-closure-flag.md) · [A8](../tasks/A8-conditional-sl-type.md) · [A9](../tasks/A9-denomination-multiplier.md) · [A11](../tasks/A11-leverage-source-tracking.md) | 8.4 h | 4/4 shipped |
| [Wave 4](../waves/wave-4.md) | Database merge | [A10](../tasks/A10-database-merge.md) | 4.3 h | 1/1 shipped |

## All 11 Tasks at a Glance

| Task | Name | Tier | Wave | Status | Canary | Merge commit |
|---|---|---|---|---|---|---|
| [A1](../tasks/A1-signal-events-schema.md) | signal_events Table + 12 Event Type Instrumentation | 🔴 CRITICAL | 1 | ✅ DONE | PASS | [`5b242c5`](https://github.com/QuantisDevelopment/oinkfarm/commit/5b242c567d0df4b8b25d3866e711f15d772e685a) |
| [A2](../tasks/A2-remaining-pct-model.md) | remaining_pct Model + Blended PnL Fix | 🔴 CRITICAL | 1 | ✅ DONE | PASS | [`6b21a20`](https://github.com/QuantisDevelopment/oink-sync/commit/6b21a2074413395b400b6f95494ae80d77ecef59) |
| [A3](../tasks/A3-auto-filled-at.md) | Auto filled_at for MARKET Orders | 🟡 STANDARD | 1 | ✅ DONE | PASS | [`3b5453b`](https://github.com/QuantisDevelopment/oinkfarm/commit/3b5453b7) |
...
| [A5](../tasks/A5-confidence-scoring.md) | Parser-Type Confidence Scoring | 🟡 STANDARD | 2 | ✅ DONE | PASS | [`69d6840`](https://github.com/QuantisDevelopment/oinkfarm/commit/69d6840a) |
...
| [A7](../tasks/A7-update-new-detection.md) | UPDATE→NEW Detection (Phantom Trade Prevention) | 🔴 CRITICAL | 2 | ✅ DONE | PASS | [`6157315`](https://github.com/QuantisDevelopment/oinkfarm/commit/61573158) |
| [A8](../tasks/A8-conditional-sl-type.md) | Conditional SL Type Field | 🟡 STANDARD | 3 | ✅ DONE | PASS | [`4615454`](https://github.com/QuantisDevelopment/oinkfarm/commit/46154543) |
| [A9](../tasks/A9-denomination-multiplier.md) | Denomination Multiplier Table (1000x-prefixed symbols) | 🟢 LIGHTWEIGHT | 3 | ✅ DONE | PASS | [`2719648`](https://github.com/QuantisDevelopment/oink-sync/commit/2719648) |
