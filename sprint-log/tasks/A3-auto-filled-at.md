...
A3 auto-populates filled_at for MARKET orders at INSERT-time. Previously it was left NULL and backfilled late (or not at all), which broke downstream latency metrics.
