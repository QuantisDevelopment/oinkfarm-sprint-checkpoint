...
**Status:** ✅ COMPLETE — 0/11 tasks shipped, canaries PASS across the board  
**Started:** —  
**Finished:** —  
**Elapsed:** —  
...
|---|---|---|---|---|
| [Wave 1](../waves/wave-1.md) | Core schema & formula primitives | [A1](../tasks/A1-signal-events-schema.md) · [A2](../tasks/A2-remaining-pct-model.md) · [A3](../tasks/A3-auto-filled-at.md) | — | 0/3 shipped |
...
| [Wave 3](../waves/wave-3.md) | Metadata enrichment & ghost closure | [A6](../tasks/A6-ghost-closure-flag.md) · [A8](../tasks/A8-conditional-sl-type.md) · [A9](../tasks/A9-denomination-multiplier.md) · [A11](../tasks/A11-leverage-source-tracking.md) | — | 0/4 shipped |
| [Wave 4](../waves/wave-4.md) | Database merge | [A10](../tasks/A10-database-merge.md) | — | 0/1 shipped |
