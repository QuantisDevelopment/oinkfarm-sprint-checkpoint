...
| [A7](../tasks/A7-update-new-detection.md) | UPDATE→NEW Detection (Phantom Trade Prevention) | 🔴 CRITICAL | ✅ DONE | PASS | [`6157315`](https://github.com/QuantisDevelopment/oinkfarm/commit/61573158) |
| [A5](../tasks/A5-confidence-scoring.md) | Parser-Type Confidence Scoring | 🟡 STANDARD | ✅ DONE | PASS | [`69d6840`](https://github.com/QuantisDevelopment/oinkfarm/commit/69d6840a) |
